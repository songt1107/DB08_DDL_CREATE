...
INSERT INTO MEMBER2 VALUES('MEN01', 'PASS01', '고길동', 7712341234);
INSERT INTO MEMBER2 VALUES('MEN02', 'PASS02', '고길순', 01012341234);
...
-- 한개 컬럼에 설정할 수도 있고, 여러 개의 컬럼을 묶어서 설정할 수 있음
...
INSERT INTO USER_USED_PK
VALUES(NULL, 'USER02', 'PASS02', '이순신', '남', '010-5678-9012', 'LEE123@kh.or.kr');
...
-- 회원 번호와 아이디 둘 다 중복되었을 때만 제약조건 위배 에러 발생
...
INSERT INTO USER_USED_FK
VALUES(5, 'USER01', 'PASS01', '홍길동', '남', '010-1234-5678', 'hong1234@kh.or.kr', 50);
-- ORA-00001: 무결성 제약 조건(KH.SYS_C008401)에 위배됩니다
...
CREATE TABLE USER_TEST2(
	...
	PHONE VARCHAR2(30),
	ADDRESS VARCHAR2(50),
	STATUS VARCHAR2(10) DEFAULT 'N' CONSTRAINT NN_USER_TEST_STATUS NOT NULL,
...
COMMENT ON COLUMN USER_TEST2.USER_NO IS '회원번호';
COMMENT ON COLUMN USER_TEST2.USER_ID IS '회원아이디';
COMMENT ON COLUMN USER_TEST2.USER_PWD IS '비밀번호';
COMMENT ON COLUMN USER_TEST2.PNO IS '주민등록번호';
COMMENT ON COLUMN USER_TEST2.GENDER IS '성별';
COMMENT ON COLUMN USER_TEST2.PHONE IS '연락처';
COMMENT ON COLUMN USER_TEST2.ADDRESS IS '주소';
COMMENT ON COLUMN USER_TEST2.STATUS IS '탈퇴여부';



INSERT INTO USER_TEST2
VALUES(1, 'USER01', 'PASS01', '910101-1111111', '남', '010-1111-9999', '서울 종로구', 'Y');

INSERT INTO USER_TEST2
VALUES(2, 'USER02', 'PASS02', '920202-2222222', '여', '010-2222-5678', '경기 이천', 'N');

INSERT INTO USER_TEST2
VALUES(3, 'USER03', 'PASS03', '930303-1333333', '남', '010-3334-5678', '전남 광주', 'Y');

INSERT INTO USER_TEST2
VALUES(4, 'USER04', 'PASS04', '940404-2444444', '여', '010-4444-5678', '충북 청주', 'N');

INSERT INTO USER_TEST2
VALUES(5, 'USER05', 'PASS05', '950505-2444444', '여', '010-5555-5678', '충북 청주', 'N');
...
-- 컬럼명, 데이터 타입, 값이 복사되고, 제약 조건은 NOT NULL 만 복사됨
...
-- EMPLOYEE 테이블의 SAL_LEVER 외래키 제약조건 추가
